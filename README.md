...
这个仓库用于定时监控 A 股、ETF 和 LOF 价格。当价格跌到设定值时，通过 Telegram 发送提醒。

当前监控：

| 名称 | 代码 | 提醒价 |
| --- | --- | ---: |
| 芯片科创ETF华安 | 588290 | 3.20 |
| 中韩半导体ETF华泰柏瑞 | 513310 | 5.65 |
| 印度基金LOF | 164824 | 1.23 |
| 黄金ETF华夏 | 518850 | 8.20 |
| 中国移动 | 600941 | 91.00 |

> 监控清单以 `config.json` 为准。这里的表格仅用于快速查看当前配置。
...
- `symbol`：股票、ETF 或 LOF 代码
- `name`：提醒里显示的名称
- `market`：`stock`、`etf` 或 `lof`
